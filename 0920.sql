...
INSERT INTO TABLE_UNIQUE(LOGIN_ID, LOGIN_PW,TEL) VALUES(NULL, 'SPHB8233', NULL);
...
-- EX) ID 및 PASSWORD 같이 제한
-- EX) 유효 값 범위 확인 (나이 / 성적 / 전화번호 / 이메일)

CREATE TABLE TABLE_CHECK (
    LOGIN_ID VARCHAR2(20) PRIMARY KEY,
    LOGIN_PW VARCHAR2(20) CHECK(LENGTH(LOGIN_PW) >= 4),
    TEL VARCHAR2(20)
);

INSERT INTO TABLE_CHECK VALUES('JKS2024', 'SPHB', '010-5006-4146');
...
INSERT INTO TABLE_DEFAULT(LOGIN_ID, LOGIN_PW) VALUES('JKS2025', 'SPHBB250');
